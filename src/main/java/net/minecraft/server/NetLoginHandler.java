...
public class NetLoginHandler extends NetHandler {
    ...
    public void disconnect(String s) {
        try {
            // Log pouze pokud není potlačeno v configu
            if (!com.legacyminecraft.poseidon.PoseidonConfig.getInstance().getConfigBoolean("settings.debug.suppress-disconnect-log", false)) {
...
//            }
    ...
    public void a(String s, Object[] aobject) {
        if (!(com.legacyminecraft.poseidon.PoseidonConfig.getInstance().getConfigBoolean("settings.debug.suppress-disconnect-log", true))) {
