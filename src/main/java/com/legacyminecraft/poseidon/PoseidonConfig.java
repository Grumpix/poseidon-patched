mpackage com.legacyminecraft.poseidon;
...
public class PoseidonConfig extends Configuration {
    ...
    private void write() {
        ...
        //Main
    // Debug settings
    generateConfigOption("settings.debug.suppress-disconnect-log", true);
    generateConfigOption("settings.debug.bad-packet-id.enabled", false);
    generateConfigOption("settings.debug.bad-packet-id.info", "Enables logging of bad packet IDs for debugging purposes. Only enable if you want to see these messages in the console.");
